...
No hay archivos `.env` ni claves API en este repositorio. No pongas claves en variables `VITE_*`: Vite las puede incluir en el paquete del navegador. La carpeta `audios/` y los guiones son material de trabajo; mantén el repositorio privado.
